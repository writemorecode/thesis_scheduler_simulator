...
from algorithms import BinInfo, ScheduleResult, TimeSlotSolution, machines_upper_bound
...
def solve_exact(
    ...
    upper_bound = machines_upper_bound(capacities, requirements, job_counts)
    ...
    solver = pulp.PULP_CBC_CMD(msg=True, timeLimit=None, threads=6, options=options)
